...
While the user is on his Homepage he can receive Notifications. When the system detects a pending notification it shows it to the user displaying a Notification screen compartment. Once the user has replied the notification compartment disappears and the user is back to his Homepage.
