...
\item \emph{Calendar page:} this package implements FR3, FR7-FR12, FR19
\item \emph{Search page:} this package implements FR12, FR14
...
\item \emph{User profile manager:} this package implements FR1, FR4-FR6
\item \emph{Calendar manager:} this package implements FR3, FR7-FR11
\item \emph{Search manager:} this package implements FR12, FR14
\item \emph{Notification manager:} this package implements FR12, FR13, FR16
...
The User entity contains all the  user's personal information. A user has exactly one calendar.  
