...
The BCE diagram in figure \ref{fig:login_bce} describes the main features of the login and registration functionalities. It displays all the parts of the MeteoCal system involved in carrying out this tasks.
...
\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{./bce/login_bce}
\caption[login bce]{Login and signup BCE diagram}
\label{fig:login_bce}
\end{figure}

\subsection{Notification and forecasts managing}
TODO: IN NOTIFICATION MANAGER AGGIUNGERE DELETE-NOTIFICATION
