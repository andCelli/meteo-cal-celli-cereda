...
\end{itemize}
In this section we describe all the subcomponents in a ``vertical way'', i.e. starting from a web component we will show how it interacts with the business logic component to achieve what it need, and how the business logic interacts with the persistence component.

\subsection{Login-Sign up}
This BCE diagram describes the main features of the login and registration functionalities. It displays all the parts of the MeteoCal system involved in carrying out this tasks. 
...
The UserHome boundary (and its related controllers) and the NotificationManager will be presented in another diagram so here we just show their roles in the login-registration functionalities.
